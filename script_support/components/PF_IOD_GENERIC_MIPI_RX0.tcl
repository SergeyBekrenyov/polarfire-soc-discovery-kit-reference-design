# Exporting Component Description of PF_IOD_GENERIC_MIPI_RX0 to TCL
# Family: PolarFireSoC
# Part Number: MPFS095T-1FCSG325E
# Create and Configure the core component PF_IOD_GENERIC_MIPI_RX0
create_and_configure_core -core_vlnv {Actel:SystemBuilder:PF_IOD_GENERIC_RX:2.1.113} -component_name {PF_IOD_GENERIC_MIPI_RX0} -params {\
...
# Exporting Component Description of PF_IOD_GENERIC_MIPI_RX0 to TCL done
